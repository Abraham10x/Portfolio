...
const Services: FC = () => {
  ...
  return (
    <div className="container py-24 px-5 sm:px-10 pb-8 2xl:px-0 mx-auto mt-0 sm:mt-10">
      <div className="flex flex-col sm:flex-row justify-between mt-5 gap-x-28">
        <div className="flex flex-col">
          {services.map((data) => (
            <div key={data.id} className="flex flex-col w-full basis-1/2">
              ...
              <div className="my-8 ml-10">
                <h3 className="font-bold text-4xl">{data.header}</h3>
        ...
        <div className="flex flex-col lg:pr-10 basis-1/2 align-top">
          ...
          <p className="text-black text-sm sm:text-xl lg:text-2xl my-3">
            Fast-forward to today, and I’ve had the privilege of working at an
            advertising agency, a <span className="text-primary">start-up</span>
            , a huge corporation,
          </p>
          <h4 className="text-black text-3xl mt-8 font-bold">My Toolkit 💻</h4>
