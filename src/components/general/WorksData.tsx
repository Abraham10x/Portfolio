...
export default [
  {
    ...
    slider: [
      "/img/projects/web/hashtag.png",
      "/img/projects/web/hashtag-home.png",
      "/img/projects/web/hashtag-contact.png",
      "/img/projects/web/hashtag-career.png",
    ],
    title: "Hashtag",
    industry: "Software Solutions",
    github: "",
    live: "https://hashtagng.com/",
    figma: "",
    summary: (
      <p className="text-black">
        Hashtag is a pan-African tech startup focused on software development
        and digital media services, which we refine into digital products for
        our endusers and by extension provide similar services to other
        corporate clients who have need for such.
        <br /> We are a team of young and passionate minds. And we have a goal,
        which is to “make things work,” especially at home in Africa.
      </p>
    ),
    tools: [
      {
  ...
  {
    id: 2,
    mainimage: "/img/projects/web/travel-now.png",
    modal: "hs-travel-now",
    slider: [
      "/img/projects/web/travel-now.png",
      "/img/projects/web/travel-hero.png",
      "/img/projects/web/travel-destination.png",
    ],
    title: "Travel Now",
    industry: "Tourism",
    github: "https://github.com/Abraham10x/Travelnow-Project",
    live: "https://travel-now-project.netlify.app/",
    figma:
      "https://www.figma.com/file/SQmyDEttYcrCCNbd9T5Aey/Travelnow?node-id=323%3A21&t=CLlNCv5akVONC1Gh-1",
    summary: (
      <p className="text-black">
        Explore Top Destination Discover Amazing Place With Exclusive Deals.
        <br /> Find Next Place To Visit Look at the Vaction Packages offered
      </p>
    ),
    tools: [
      {
  ...
  {
    id: 3,
    mainimage: "/img/projects/web/watchlist.png",
    modal: "hs-cmovie-watchlist",
    slider: [
      "/img/projects/web/watchlist.png",
      "/img/projects/web/movie-hero.png",
      "/img/projects/web/movie-store.png",
      "/img/projects/web/movie-find.png",
    ],
    title: "Movie Watchlist",
    industry: "Entertianment",
    github: "https://github.com/Abraham10x/Movie-Watchlist",
    live: "https://omd-movie-api-project.netlify.app/",
    figma: "",
    summary: (
      <p className="text-black">
        this project enables users to search for any movie title with a
        particular search query pattern e,g "IRON MAN" or "SPIDER-MAN" to get a
        list correct resulting movies, with some information about each movie
        item. <br /> this project makes use of the OMDB (Open Movie Data Base)
        API and user can click on the add watchlist icon to add that particular
        movie item to another database "localStorage" and when you click on the
        next page called "MY WATCHLIST" you will be able to access your saved
        movies
      </p>
    ),
    tools: [
  ...
  },
  {
    ...
    github: "https://github.com/Abraham10x/Portfolio",
    live: "https://amehabraham.netlify.app/",
    figma:
  ...
  {
    id: 5,
    mainimage: "/img/projects/design/vaneto.png",
    modal: "hs-vaneto-store",
    slider: [
      "/img/projects/design/vaneto.png",
      "/img/projects/design/vaneto-home.png",
      "/img/projects/design/vaneto-hero.png",
    ],
    title: "Vaneto Furniture",
    industry: "E-commerce",
    github: "",
    live: "",
    figma:
